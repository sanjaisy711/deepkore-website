        ...
        <div className="container relative">
            ...
            <div id="navigation" style={{ display: isMenu ? 'block' : 'none' }}>
                <ul className={`navigation-menu ${navClass} ${navJustify}`}>
                    ...
                    <li className={manu === "/auth-signup" || "" ? "active" : ""}><Link href="auth-signup" className="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Get Started</Link></li>
