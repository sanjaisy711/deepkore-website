                ...
                navClass === "nav-light" ?
                    <Link className="logo" href="/">
                        <span className="inline-block dark:hidden">
                            <Image src='/images/dark-logo.svg' className="l-dark" width={168} height={34}  alt="" />
                            <Image src='/images/light-logo.svg' className="l-light" width={168} height={34} alt="" />
                        </span>
                        <Image src='/images/light-logo.svg' width={168} height={24} className="hidden dark:inline-block" alt="" />
                    </Link>
                    :
                    <Link className="logo" href="/">
                        <Image src='/images/dark-logo.svg' width={168} height={34} className="inline-block dark:hidden" alt="" />
                        <Image src='/images/light-logo.svg' width={168} height={34} className="hidden dark:inline-block" alt="" />
                    </Link>
            }
