...

            {
                navClass !== 'nav-light' ? <ul className={`buy-button list-none space-x-1 mb-0`} >
                        ...
                        <li className="inline ps-1 mb-0">
                            <Link href="https://1.envato.market/worksbyte-next" target="_blank" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><BsCart3 className="size-4" /></Link>
                        </li>
                    ...
                    <li className="inline ps-1 mb-0">
                        <Link href="https://1.envato.market/worksbyte-next" target="_blank">
                ...
                <ul className={`navigation-menu ${navClass} ${navJustify}`}>
                    ...
                    <li className={`${["/aboutus", "/features","/page-team", "/pricing","/page-testimonial","/user-profile","/user-billing","/user-payment","/user-invoice","/user-notification","/user-setting","/property-listing","/property-detail","/course-listing","/course-detail","/nft-explore","/nft-auction","/nft-collection","/nft-creators","/nft-creator-profile","/nft-creator-profile-edit","/nft-wallet","/nft-create-item","/nft-detail","/food-recipe","/shop-grid","/shop-grid","/shop-grid-two","/shop-item-detail","/shop-cart","/shop-checkout","/food-recipe","/shop-grid","/shop-grid-two","/shop-item-detail","/shop-cart","/shop-checkout","/shop-account","/food-recipe","/shop-grid","/shop-grid-two","/shop-item-detail","/shop-cart","/shop-checkout","/shop-account","/photography-about","/photography-portfolio","/page-job-grid","/page-job-detail","/page-job-apply","/page-job-post","/page-job-career","/page-job-candidates","/page-job-candidate-detail","/page-job-companies","/page-Job-company-detail","/forums-topic","/forums-comments","/helpcenter-overview","/helpcenter-faqs","/helpcenter-guides","/helpcenter-support","/blog","/blog-sidebar","/blog-detail","/blog-standard-post","/blog-slider-post","/blog-gallery-post","/blog-youtube-post","/blog-vimeo-post","/blog-audio-post","/blog-blockquote-post","/blog-left-sidebar-post","/email-confirmation","/email-password-reset","/email-alert","/email-invoice","/auth-login","/auth-signup","/auth-re-password","/auth-lock-screen","/page-terms","/page-privacy","/page-comingsoon","/page-maintenance","/page-error","/page-thankyou","/contact-detail","/contactus","/contact-two","/page-services","/page-service-detail"].includes(manu)? "active" : ""} has-submenu parent-parent-menu-item`}>
                        ...
                        <ul className="submenu">
                            ...
                            <li className={`${["/contact-detail", "/contactus","/contact-two"].includes(manu)? "active" : ""} has-submenu parent-menu-item`}><Link href="#"> Contact </Link><span className="submenu-arrow"></span>
                                <ul className="submenu">
                                    <li className={manu === "/contact-detail" || "" ? "active" : ""}><Link href="/contact-detail" className="sub-menu-item">Contact Detail</Link></li>
                                    <li className={manu === "/contactus" || "" ? "active" : ""}><Link href="/contactus" className="sub-menu-item">Contact One</Link></li>
                    ...
                    <li className={manu === "/contactus" || "" ? "active" : ""}><Link href="/contactus" className="sub-menu-item">Contact</Link></li>
                </ul>
            </div>
        </div >
    </nav >
