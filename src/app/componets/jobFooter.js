                    ...
                    <div className="py-[30px] px-0">
                        <div className="grid md:grid-cols-2 items-center">
                            ...
                            <ul className="list-none space-x-1 footer-list md:text-end text-center mt-6 md:mt-0">
                                ...
                                <li className="inline mt-[10px]"><Link href="/contactus" className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out ms-2">Contact</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="container relative text-center">
                    <div className="grid grid-cols-1">
                        <div className="text-center">
                            <p className="mb-0">© {new Date().getFullYear()} worksbyte. Design & Develop with <i className="mdi mdi-heart text-red-600"></i> by <Link href="/https://shreethemes.in/" target="_blank"className="text-reset">Shreethemes</Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
