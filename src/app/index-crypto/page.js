                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="lg:col-span-7">
                        <div className="lg:ms-10">
                            ...
                            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Buy Cryptocurrency <br /> with worksbyte</h3>
        ...
        <section className="relative md:py-24 py-16 md:pb-0 pb-0">
                ...
                <div className="grid md:grid-cols-12 grid-col-1 items-center gap-[30px]">
                    <div className="lg:col-span-5 md:col-span-6 order-2 md:order-1">
                        <div className="shadow dark:shadow-gray-800 rounded-md p-6 bg-gray-50 dark:bg-slate-800 overflow-hidden">
                            ...
                            <h5 className="text-center font-semibold text-2xl mt-3">worksbyte Token Sale</h5>
                    ...
                    <div className="lg:col-span-7 md:col-span-6 order-1 md:order-2">
                        <div className="lg:ms-10">
                            ...
                            <p className="text-slate-400 para-desc mx-auto mb-3">With worksbyte Trade, you can be sure your trading skills are matched with excellent service.</p>
                            <p className="text-slate-400 para-desc mx-auto">worksbyte Institutional Markets is a full-stack crypto services platform that works with crypto-native businesses and institutional clients on lending, trading, and custody solutions tailored to your needs.</p>
                            <div className="mt-4">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">With worksbyte Trade, you can be sure your trading skills are matched with excellent service.</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
                    <div className="flex">
                        ...
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold">How our <span className="text-indigo-600">worksbyte</span> work ?</h5>
                    ...
                    <div className="flex">
                        <Icon.HelpCircle className="fea icon-ex-md text-indigo-600 me-3"></Icon.HelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold"> Is <span className="text-indigo-600">worksbyte</span> safer to use with my account ?</h5>
