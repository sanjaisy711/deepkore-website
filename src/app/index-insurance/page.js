                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div className="md:col-span-7">
                        <div className="md:me-6">
                            <div className="bg-white dark:bg-slate-900 text-slate-400 py-2 px-4 inline-flex items-center font-medium rounded-full shadow dark:shadow-gray-800"><span className="bg-indigo-600 text-white text-[12px] font-bold px-2.5 py-0 rounded-full me-2">worksbyte</span> Get an insurance</div>
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div className="order-2 lg:order-1 lg:mt-0 mt-8">
                        <div className="lg:me-6 text-center lg:text-start">
                            ...
                            <p className="text-white/80 max-w-xl mx-auto lg:ms-auto">Start working with worksbyte that can provide everything you need to generate awareness, drive traffic, connect.</p>
