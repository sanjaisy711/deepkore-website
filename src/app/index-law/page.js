                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="lg:col-span-7 md:col-span-6 mt-8 md:mt-0">
                        <div className="lg:ms-5">
                            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Welcome to worksbyte <br /> Law Firm Company</h3>
        ...
        <section className="pt-20 pb-32 w-full table relative bg-center bg-no-repeat bg-cover" style={{backgroundImage:"url('/images/business/bg02.jpg')"}}>
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 text-center">
                    ...
                    <p className="text-white/80 max-w-xl mx-auto mb-0">Start working with worksbyte that can provide everything you need to generate awareness, drive traffic, connect.</p>
