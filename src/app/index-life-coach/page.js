        ...
        <section class="py-20 w-full table relative bg-top bg-no-repeat bg-cover" style={{backgroundImage:'url("/images/coach/cta.jpg")'}}>
            ...
            <div class="container relative">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <p class="text-white/80 max-w-xl mx-auto">Start working with worksbyte that can provide everything you need to generate awareness, drive traffic, connect.</p>
