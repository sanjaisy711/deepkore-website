                    ...
                    <div className="relative grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                        <div className="md:col-span-6">
                            <div className="md:me-8">
                                ...
                                <p className="text-slate-400 text-lg max-w-xl">worksbyte allows you to design dynamic business apps that adapt to your needs. One platform. No-code. Hassle-free</p>
            ...
            <section className="relative md:pb-24 pb-16 overflow-hidden">
                <div className="container relative">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        ...
                        <p className="text-slate-400 max-w-xl mx-auto">Optimize your workflows and keep your employees at peak productivity. worksbyte allows you to build apps that keep up with your business's fast pace and growth without a single line of code</p>
                    </div>
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid grid-cols-1 pb-8 text-center wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Why Everyone Loves worksbyte</h3>
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                        ...
                        <div className="lg:ms-8 wow animate__animated animate__fadeInRight" data-wow-delay=".3s">
                            ...
                            <p className="text-slate-400">Optimize your workflows and keep your employees at peak productivity. worksbyte allows you to build apps that keep up with your business's fast pace and growth without a single line of code.</p>
