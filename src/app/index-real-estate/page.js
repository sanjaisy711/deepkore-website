                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="md:col-span-7">
                        <div className="lg:ms-4">
                            ...
                            <p className="text-slate-400 max-w-xl">worksbyte Homes developed a platform for the Real Estate marketplace that allows buyers and sellers to easily execute a transaction on their own. The platform drives efficiency, cost transparency and control into the hands of the consumers. worksbyte Homes is Real Estate Redefined.</p>
