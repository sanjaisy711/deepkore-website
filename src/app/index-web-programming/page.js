        ...
        <section className="py-20 w-full table relative bg-fixed bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url('/images/programming/bg.jpg')`}}>
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 text-center">
                    ...
                    <p className="text-white/70 max-w-xl mx-auto">Start working with worksbyte that can provide everything you need to generate awareness, drive traffic, connect.</p>
