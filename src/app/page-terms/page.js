                        ...
                        <div className="md:w-3/4">
                            <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                                ...
                                <p className="text-slate-400">To access certain features of our Services, you may be required to create an account. You agree to:</p>
                                 ...
                                 className="text-slate-400">We reserve the right to terminate accounts that provide false or misleading information or violate these <b className="text-red-600">Terms</b>.</p>
