                    ...
                    <div className="md:flex justify-center">
                        <div className="md:w-3/4">
                            <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                                ...
                                <p className="text-slate-400">Our platform enables users to create, manage, and deploy applications using <b className="text-red-600"> low-code/no-code </b> tools. The specific services we offer may include</p>
                                ...
                                <p className="text-slate-400">To access certain features of our <b className="text-red-600"> Services </b> , you may be required to create an account. You agree to:</p>
                                   <ul className="list-none text-slate-400 mt-3">
                                ...
                                <p className="text-slate-400">All content, technology, and intellectual property <b className="text-red-600"> rights </b> on our platform, including software, logos, and designs, are owned by or licensed to us. You agree not to copy, distribute, or create derivative works based on our platform without prior written permission.</p>

                                  <h3 className="text-lg font-semibold mb-4 mt-8">7.2. Your Content:</h3>
                                <p className="text-slate-400">You retain ownership of any content, data, or applications you create using our platform. By using our Services, you grant us a worldwide, royalty-free license to use, host, store, reproduce, and display your content solely for the purpose of providing the<b className="text-red-600"> Services </b> to you.</p>




                                     <h5 className="text-xl font-semibold mb-4 mt-8">8. Third-Party Services</h5>
                                <p className="text-slate-400">Our platform may integrate with or allow you to use third-party services. These third-party <b className="text-red-600"> services </b>are not controlled by us, and their use is subject to their own terms and privacy policies. We are not responsible for the content, accuracy, or reliability of any third-party services.</p>
                                ...
                                <p className="text-slate-400">The<b className="text-red-600"> Services </b> are provided "as is" and "as available" without warranties of any kind, whether express or implied, including, but not limited to, implied warranties of merchantability, fitness for a particular purpose, non-infringement, or course of performance.</p>
                                ...
                                <p className="text-slate-400">These Terms will be governed by and construed in accordance with the laws of [Jurisdiction], without regard to its conflict of law principles. Any legal action or proceeding arising under these<b className="text-red-600"> Terms </b> will be brought exclusively in the courts located in [Jurisdiction], and you hereby consent to the jurisdiction of such courts.</p>


                                 <h5 className="text-xl font-semibold mb-4 mt-8">14. Contact Us</h5>
                                <p className="text-slate-400">If you have any questions about these<b className="text-red-600"> Terms </b> or the <b className="text-red-600"> Services </b> , please contact us at:<Link href="#" className="relative inline-flex items-center font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:duration-500 text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500">contact@worksbyte.com</Link></p>
