                                ...
                                <div className="md:flex justify-between">
                                    <div>
                                        ...
                                        <div className="flex mt-4">
                                            ...
                                            <Link href="#"className="text-indigo-600 dark:text-white font-medium">https://1.envato.market/worksbyte-next</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 md:mt-0 md:w-56">
                                        ...
                                        <ul className="list-none">
                                            ...
                                            <li className="flex mt-3">
                                                ...
                                                <Link href="/mailto:contact@example.com" className="text-slate-400">info@worksbyte.com</Link>
                                            </li>
